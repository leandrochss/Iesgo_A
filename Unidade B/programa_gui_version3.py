...
class UserManagementApp:
    def __init__(self, root):
        ...
        def load_data(self):
            # Carregar os dados do banco e exebir no Treeview (janela)
    ...
    def add_user_window(self):
        ...
        add_user_window.tiitle('Adiconar novo usuário')
        ...
        def delet_user(self):
            ...
            if selected_item:
                ...
                tk.messagebox('Erro', 'Selecione um usuário para remover da lista')
